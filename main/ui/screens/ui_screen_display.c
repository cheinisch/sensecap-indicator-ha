...
lv_obj_t * ui_sleep_mode_time = NULL;
lv_obj_t * ui_after1 = NULL;
lv_obj_t * ui_sleep_mode_time_cfg = NULL;
lv_obj_t * ui_min1 = NULL;
lv_obj_t * ui_sleep_mode = NULL;
lv_obj_t * ui_sleep_mode_title = NULL;
lv_obj_t * ui_sleep_mode_cfg = NULL;
lv_obj_t * ui_brighness1 = NULL;
lv_obj_t * ui_brighness_cfg = NULL;
lv_obj_t * ui_brighness_title = NULL;
lv_obj_t * ui_brighness_icon_3 = NULL;
lv_obj_t * ui_brighness_icon_4 = NULL;
lv_obj_t * ui_display_keyboard = NULL;
lv_obj_t * ui_display_title1 = NULL;
...
void ui_screen_display_screen_destroy(void)
{
    if(ui_screen_display) lv_obj_del(ui_screen_display);

    // NULL screen variables
    ui_screen_display = NULL;
    ui_sleep_mode_time = NULL;
    ui_after1 = NULL;
    ui_sleep_mode_time_cfg = NULL;
    ui_min1 = NULL;
    ui_sleep_mode = NULL;
    ui_sleep_mode_title = NULL;
    ui_sleep_mode_cfg = NULL;
    ui_brighness1 = NULL;
    ui_brighness_cfg = NULL;
    ui_brighness_title = NULL;
    ui_brighness_icon_3 = NULL;
    ui_brighness_icon_4 = NULL;
    ui_display_keyboard = NULL;
    ui_display_title1 = NULL;
    ui_back3 = NULL;
