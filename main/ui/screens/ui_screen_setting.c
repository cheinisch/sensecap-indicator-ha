...
lv_obj_t * ui_panel_top_4 = NULL;
lv_obj_t * ui_time_ha_data3 = NULL;
lv_obj_t * ui_wifi__st_button_ha_setting = NULL;
lv_obj_t * ui_wifi_st_4 = NULL;
lv_obj_t * ui_Container_Setting = NULL;
lv_obj_t * ui_setting_title1 = NULL;
lv_obj_t * ui_setting_icon1 = NULL;
lv_obj_t * ui_setting_wifi1 = NULL;
lv_obj_t * ui_setting_wifi_icon1 = NULL;
lv_obj_t * ui_setting_wifi_title1 = NULL;
lv_obj_t * ui_setting_display1 = NULL;
lv_obj_t * ui_setting_display_icon1 = NULL;
lv_obj_t * ui_setting_display_title1 = NULL;
lv_obj_t * ui_scrolldots1 = NULL;
lv_obj_t * ui_scrolldots2 = NULL;
lv_obj_t * ui_scrolldots4 = NULL;
lv_obj_t * ui_scrolldots5 = NULL;
lv_obj_t * ui_setting_display2 = NULL;
...
void ui_screen_setting_screen_destroy(void)
{
    ...
    ui_panel_top_4 = NULL;
    ui_time_ha_data3 = NULL;
    ui_wifi__st_button_ha_setting = NULL;
    ui_wifi_st_4 = NULL;
    ui_Container_Setting = NULL;
    ui_setting_title1 = NULL;
    ui_setting_icon1 = NULL;
    ui_setting_wifi1 = NULL;
    ui_setting_wifi_icon1 = NULL;
    ui_setting_wifi_title1 = NULL;
    ui_setting_display1 = NULL;
    ui_setting_display_icon1 = NULL;
    ui_setting_display_title1 = NULL;
    ui_scrolldots1 = NULL;
    ui_scrolldots2 = NULL;
    ui_scrolldots4 = NULL;
    ui_scrolldots5 = NULL;
    ui_setting_display2 = NULL;
    ui_Label1 = NULL;
